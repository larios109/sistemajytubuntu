    ...
    <form action="{{route('materiasaliente.update',$materiasalientes->cod_materia_s)}}" method='POST' id="formstore">
        ...
        <div class="card  mb-6">
            ...
            <div  class="row mb-3">
                ...
                <div class="col-sm-7">
                    <input type="text" id="Materia" name="Materia" class="form-control" readonly="" value="{{$materiasalientes->nom_materia}}">
                </div>
            ...
            <div  class="row mb-3">
                <div class="col-sm-7">
                    <input type="number" id="codm" name="codm" class="form-control" hidden readonly="" value="{{$materiasalientes->cod_materia_e}}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Descripcion</label>
                 <div class="col-sm-7">
                    ...
                    placeholder="Ingrese una descripcion" value="{{$materiasalientes->descripcion_s}}">{{$materiasalientes->descripcion_s}}</textarea>
                </div>
