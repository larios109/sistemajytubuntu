...
@section('title', '| Registrar Producto en Inventario')
        ...
        <div class="card  mb-2">
            ...
            <div  class="row mb-3">
                ...
                <select class="col-sm-7" class="form-control" id="Producto" name="Producto">
                    ...
                    @foreach($productos as $producto)
                        {
                            <option  id=".$producto['Producto']">{{$producto["cod_producto"]}}.{{$producto["nombre_producto"]}}</option>
                        }
                    @endforeach
                </select>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Cantidad</label>
                 <div class="col-sm-7">
                    <input type="number" id="cantidad" name="cantidad"  class="form-control" min="1" max="9999999999" maxlength="10" 
