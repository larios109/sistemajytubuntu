...
@section('content')
    <form action="{{route('kardex.store')}}" method='POST' id="formstore">
        @csrf
        <div class="card  mb-2">
            ...
            <div  class="row mb-3">
                <div class="col-sm-7">
                    <input type="number" id="codproducto" name="codproducto"  hidden class="form-control" readonly="">  
                </div>
            </div>
            ...
            <div  class="row mb-3">
                <div class="col-sm-7">
                    <input type="number" id="nuevostock" name="nuevostock"  hidden class="form-control" readonly="">  
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach($articulos as $art)
                                        <tr>
                                            ...
                                            <td class="text-center" id="t1">{{$art->nombre}}</td>
                                            <td class="text-center" id="t2">{{$art->stock}}</td>
                                            <td class="text-center">{{$art->tip_medida}}</td>
                                        </tr>
                                    @php $i++; @endphp
                                    @endforeach
                                </tbody>
...
<script>
    ...
    form.addEventListener("submit", function(event){
            ...
            if (reduccionStock >= stockactual) {
                ...
                $("#cantidad").val("");
                alert("Si desea Incrementar el stock dirijase a productos");
                cont++;
            }
        } 
    )
