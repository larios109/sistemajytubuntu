...
@section('title', '| Actualizar Pregunta')
...
@section('content')
    <form action="{{route('preguntas.update', $actualizarpregunta->cod_pregunta)}}" method='POST'>
        @csrf
        @method('PUT')
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Pregunta</label>
                 <div class="col-sm-7">
                    ...
                    placeholder="Ingrese la pregunta" value="{{$actualizarpregunta->pregunta}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Respuesta</label>
                 <div class="col-sm-7">
                    ...
                    placeholder="Ingrese la respuesta" value="{{$actualizarpregunta->respuesta}}">
                </div>
