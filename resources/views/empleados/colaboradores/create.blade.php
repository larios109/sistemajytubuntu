    ...
    <form action="{{route('colaboradores.store')}}" method='POST'>
        ...
        <div class="card  mb-2">
            ...
            <div  class="row mb-3">
                ...
                <div class="col-sm-7">
                    <input type="text" id="persona" name="persona" class="form-control" readonly="" required>
                </div>
            ...
            <div  class="row mb-3">
                <div class="col-sm-7">
                    <input type="number" id="codp" name="codp" hidden class="form-control" readonly="">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Sueldo</label>
                 <div class="col-sm-7">
                    <input type="number" id="Sueldo" name="Sueldo" min="1" max="999999" maxlength="10" step="0.00001" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Ingrese el sueldo bruto" value="{{old('SueldoB')}}">
                </div>
