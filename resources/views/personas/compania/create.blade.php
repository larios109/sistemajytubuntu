...
@section('title', '| Registrar compañia')
        ...
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Compañia CAI</label>
                 <div class="col-sm-7">
                    <input type="text" id="CAI" name="CAI" class="form-control" maxlength="40" placeholder="Ingrese el cai" value="{{old('CAI')}}">
                </div>
                @if ($errors->has('CAI'))
                    <div                 
                        id="CAI-error"                             
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Nombre legal</label>
                 <div class="col-sm-7">
                    <input type="text" id="Nombre" name="Nombre" class="form-control" maxlength="20" onkeydown="return /[a-z, ]/i.test(event.key)" onkeyup="capitalizarPrimeraLetralegal()"  placeholder="Ingrese el Nombre" value="{{old('Nombre')}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Nombre Comercial</label>
                 <div class="col-sm-7">
                    <input type="text" id="Comercial" name="Comercial"  class="form-control" maxlength="20" onkeydown="return /[a-z, ]/i.test(event.key)"  onkeyup="capitalizarPrimeraLetracomercial()" placeholder="Ingrese el nombe comercial" value="{{old('Comercial')}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Facebook</label>
                 <div class="col-sm-7">
                    <input type="text" id="Facebook" name="Facebook" class="form-control" maxlength="20" placeholder="Ingrese el feacebook" value="{{old('Facebook')}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Instagram</label>
                 <div class="col-sm-7">
                    <input type="text" id="Instagram" name="Instagram" class="form-control" maxlength="20" placeholder="Ingrese el instagram" value="{{old('Instagram')}}">
                </div>
