        ...
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Nombre Oficina</label>
                 <div class="col-sm-7">
                    <input type="text" id="Nombre" name="Nombre" class="form-control" maxlength="15" onkeydown="return /[a-z, ]/i.test(event.key)" onkeyup="capitalizarPrimeraLetraoficina()" placeholder="Ingrese el Nombre" value="{{$oficinactu->oficina_nombre}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Direccion Oficina</label>
                 <div class="col-sm-7">
                    <input type="text" id="Direccion" name="Direccion" class="form-control" maxlength="25" onkeyup="capitalizarPrimeraLetradireccion()" placeholder="Ingrese la direccion" value="{{$oficinactu->oficina_direccion}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Telefono 1</label>
                 <div class="col-sm-7">
                    <input type="number" id="Telefono1" name="Telefono1" class="form-control" min="1" max="99999999" maxlength="8" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Ingrese el Telefono" value="{{$oficinactu->oficina_telefono_1}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Telefono 2</label>
                 <div class="col-sm-7">
                    <input type="number"  id="Telefono2" name="Telefono2"   class="form-control" min="1" max="99999999" maxlength="8" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Ingrese el Telefono" value="{{$oficinactu->oficina_telefono_2}}">
                </div>
